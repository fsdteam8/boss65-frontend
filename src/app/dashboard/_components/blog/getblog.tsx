      ...
      <div className="p-[40px]">
        ...
        <div className="bg-[#FFFFFF] rounded-lg shadow overflow-hidden">
          <div className="grid grid-cols-12  px-[16px] border-b border-gray-200 bg-white">
            <div className="col-span-6 font-medium py-[20px] text-[16px]">Blog Name</div>
            <div className="col-span-3 font-medium py-[20px] text-[16px]">Added</div>
            <div className="col-span-3 font-medium py-[20px] text-right text-[16px]">Action</div>
          </div>

          {Array.from({ length: 7 }).map((_, index) => (
            <div key={index} className="grid grid-cols-12 py-4 px-6 border-b border-gray-100 items-center">
              <div className="col-span-6 flex items-center">
                ...
                <span className="truncate">Lorem ipsum dolor sit amet, conse...</span>
              </div>
          ...
          <div className="flex items-center justify-between py-4 px-6">
            <div className="text-sm text-gray-600">
              Showing <span className="font-medium">7</span> to <span className="font-medium">7</span> of{" "}
            ...
            <div className="flex items-center space-x-1">
              ...
              <Link href="#" className="px-3 py-1 rounded hover:bg-gray-100 bg-white">
                1
              </Link>
              <Link href="#" className="px-3 py-1 rounded bg-gray-100 text-gray-700">
                2
              </Link>
              <Link href="#" className="px-3 py-1 rounded hover:bg-gray-100 bg-white">
                3
